...
<script>
  export default {
    ...
    methods:{
          ...
          this.axios.post("/user/register",str).then(
            (res)=>{
              ...
              if(res.data.code==0){
                ...
                alert(res.data.msg);
                if(sessionStorage.getItem("gobacklogin")=="true"){
                  sessionStorage.setItem("gobacklogin","false");
                  history.go(-1);
                }else{
      ...
      //     if(from.path == "/login"){
      //     sessionStorage.setItem("gobacklogin","true");
      //     //this.gobacklogin = true;
      //     }
      //       next();
