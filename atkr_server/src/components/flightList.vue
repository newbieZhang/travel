...
import traveldigest from './common/travelDigest.vue';
  export default {
    ...
    methods: {
      listitemtofather1:function(ystime,yetime,sap,tap,ytime,chooseprice,fid,price){
              this.ystime1=ystime;
              this.yetime1=yetime;
              this.sap1=sap;
              this.tap1=tap;
      ...
      listitemtofather2:function(ystime,yetime,sap,tap,ytime,chooseprice,fid,price){
              this.ystime2=ystime;
              this.yetime2=yetime;
              this.sap2=sap;
              this.tap2=tap;
    ...
    created(){     
      this.$router.beforeEach(function(to,from,next){
				var ser = sessionStorage.setItem('referrer',from.path) //储存来源路由
      })
