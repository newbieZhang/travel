...
<div class="containers">
    <table class="flight_list">
        <thead>
            ...
            <tr>
                <td style="width:50%;">
                    <span style="text-align:center;color:#ed0000; font-size:1.5rem;font-weight:700;padding-left:5.5rem">舱位选择</span>
                </td>
                <td style="text-align:center;color:#051035; font-size:1.5rem;font-weight:700;">
                    <span>经济舱</span>
                </td>
                <td style="text-align:center;color:#051035; font-size:1.5rem;font-weight:700;">
                    <span>商务舱</span>
